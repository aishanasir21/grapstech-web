...
const cardData = [
  {
    number: "16x",
    text: "Plumbing & Sanitary works under the Contracting service, ensuring efficient water supply and drainage solutions."
  },
  {
    number: "24x",
    text: "Plaster & Cladding Works Contracts under the Construction service, providing durable and high-quality finishing for buildings."
  },
  {
    number: "40x",
    text: "Equipment Installation under the Electro-mechanical service, ensuring professional setup and seamless operation of all machinery."
  }
]
