            ...
            <div className='h-auto w-full flex flex-col md:flex-row items-start md:mt-5'>
                <div className='h-auto w-full relative pt-14'>
                    ...
                    <div className='w-auto md:w-4/6 mb-8'>
                        <Paragraph className='font-[font4] text-2xl md:text-3xl mx-[1vw] mt-2 tracking-wide mb-7'>We’re committed to creating high-performance hardscaping products for modern urban living that have minimal impact on our environment.</Paragraph>
                        <Paragraph className='font-[font4] text-sm md:text-sm mx-[1vw] mt-4 opacity-55 tracking-wider mb-7'>We’re proud to be the only grate manufacturer with four ticks under the SGBC Architectural Drain Covers category. Plus, we’ve earned other global accreditations for our commitment towards recycling, lowering our carbon footprint, and our waste, water and energy management.</Paragraph>
