        ...
        <div>
            <div className='p-2 h-auto w-auto'>
                <div className='flex flex-col md:flex-row mt-20 md:mt-60 gap-5 md:gap-60 justify-between items-baseline'>
                    <Title text='Results' />
                    <Paragraph className='font-[font4] text-2xl sm:text-3xl md:text-4xl mx-[2vw] leading-tight my-2 pb-6 md:pb-6'>
                        From innovation and production to delivery, we consider sustainable design every step of the way.</Paragraph>
                </div>
                <HeroLine />
                <Cards />
            </div>
