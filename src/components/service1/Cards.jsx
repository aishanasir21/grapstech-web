...
const cardData = [
  {
    number: "16+",
    text: "Completed HVAC installations across residential, commercial, and industrial projects with consistent performance and reliability."
  },
  {
    number: "24/7",
    text: "Round-the-clock maintenance and support services to ensure uninterrupted cooling and ventilation operations."
  },
  {
    number: "40%",
    text: "Energy optimization through efficient system design, smart controls, and high-performance air-conditioning solutions."
  }
]
